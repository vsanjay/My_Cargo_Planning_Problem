...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        for action in self.all_actions:
            ...
            if new_node.prenodes.issubset(previous_s_level):
                new_action_nodes.add(new_node)
        ...
        self.a_levels.append(new_action_nodes)
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        if (same_symbol == True) & (same_sign == False):
            return True
    ...
    def h_levelsum(self) -> int:
        ...
        for goal in goals:
            ...
            #iterating through all state levels.If we find our node,then add it to level sum.
